...
namespace WebStore.Data
{
    public static class TestData
    {
        ...
        public static IEnumerable<Product> Products { get; } = new[]
        {
            ...
            new Product{ Id = 3, Name = "Easy Polo Black Edition", Price = 1025,
            ...
            new Product{ Id = 8, Name = "Easy Polo Black Edition", Price = 1025,
                ImgUrl = "product8.jpg", Order = 7, SectionId = 25, BrandId = 2},
            new Product{ Id = 9, Name = "Easy Polo Black Edition", Price = 1025,
                ImgUrl = "product9.jpg", Order = 8, SectionId = 25, BrandId = 2},
            new Product{ Id = 10, Name = "Easy Polo Black Edition", Price = 1025,
                ImgUrl = "product10.jpg", Order = 9, SectionId = 25, BrandId = 3},
            new Product{ Id = 11, Name = "Easy Polo Black Edition", Price = 1025,
                ImgUrl = "product11.jpg", Order = 10, SectionId = 25, BrandId = 3},
            new Product{ Id = 12, Name = "Easy Polo Black Edition", Price = 1025,
                ImgUrl = "product12.jpg", Order = 11, SectionId = 25, BrandId = 3},
        };
    }
}
